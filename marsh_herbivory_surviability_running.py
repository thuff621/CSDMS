    ...
    for cell in model.grid.coord_iter():
        ...
        for agent in cell_content:
            if type(agent) is GrassPatch:
                veg = agent.biomass / 700  # 700 is the maximum biomass available.
...
class HerbivoreGrass(Model):
    ...
    def __init__(
        ...
        for i in range(self.initial_herbivores):
            ...
            # make sure they aren't placed outsite of the range
...
class mainEvolution(Component):
    ...
    def run_one_step(self, timeStep, round, model_domain,
        ...
        # start herbivore params
        hb = HerbivoreGrass(grass=True, gridShape=self._grid.shape)
...
grid_raster = 'Gull_Island_10meter.asc'
