...
This script was modified from Greg Tucker's original implementation from LandLab
https://landlab.readthedocs.io/en/latest/_modules/landlab/components/tidal_flow/tidal_flow_calculator.html#TidalFlowCalculator

We found issues with the spsolve function getting a singular solution issues. A try/except statement was included to
handle different solutions.
...
class TidalFlowCalculator(Component):
    ...
    def run_one_step(self):
        ...
        This section was modified by ERDC to allow for multiple matrix solutions and avoid errors with single matrix solutions
        ...
        try:
            ...
            print("A backup matrix solution was used")
            tidal_wse[self.grid.core_nodes] =  lsqr(mat, rhs, iter_lim=5000)[0]
